...
public class PlayerActivity extends AppCompatActivity {
    ...
    Button btnPlay, btnNext, btnPrev, btnForward, btnRew;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("SPlayer Music Player");
        ...
        imageView = findViewById(R.id.songImgView);
